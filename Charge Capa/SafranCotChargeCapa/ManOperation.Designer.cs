namespace SafranCotChargeCapa
{
	partial class ManOperation
	{
		...
		private void InitializeComponent()
		{
			...
			this.machineCycleList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle17;
			...
			this.machineCycleList.DefaultCellStyle = dataGridViewCellStyle18;
			...
			this.machineCycleList.RowHeadersDefaultCellStyle = dataGridViewCellStyle19;
			...
			this.machineCycleList.RowsDefaultCellStyle = dataGridViewCellStyle20;
			...
			this.outilsgrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle21;
			...
			this.outilsgrid.DefaultCellStyle = dataGridViewCellStyle22;
			...
			this.outilsgrid.RowHeadersDefaultCellStyle = dataGridViewCellStyle23;
			...
			this.outilsgrid.RowsDefaultCellStyle = dataGridViewCellStyle24;
