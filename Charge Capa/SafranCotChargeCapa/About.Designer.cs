namespace SafranCotChargeCapa
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Load/Capacity Digital Software";
			// 
			// label3
			// 
			...
			this.label4.Text = "Designed and developed by :";
			// 
			// label5
			// 
			...
			this.label7.Text = "Contact : ajiladel@gmail.com";
			// 
			// materialRaisedButton1
			// 
			this.materialRaisedButton1.Depth = 0;
			this.materialRaisedButton1.Location = new System.Drawing.Point(50, 187);
			this.materialRaisedButton1.MouseState = MaterialSkin.MouseState.HOVER;
			this.materialRaisedButton1.Name = "materialRaisedButton1";
			this.materialRaisedButton1.Primary = true;
			this.materialRaisedButton1.Size = new System.Drawing.Size(215, 30);
